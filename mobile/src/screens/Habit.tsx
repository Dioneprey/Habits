...
export function Habit() {
    ...
    async function handleToggleHanit(habitId: string) {
        try {
                ...
                })}>
                    {
                        dayInfo?.possibleHabits ?
                            dayInfo?.possibleHabits.map((habit) => {
                                return (
                                    <Checkbox disabled={isDatePast} key={habit.id} title={habit.title} checked={completedHabits.includes(habit.id)} onPress={() => handleToggleHanit(habit.id)} />
                                )
                            }) : <HabitsEmpty />
                    }
                </View>
